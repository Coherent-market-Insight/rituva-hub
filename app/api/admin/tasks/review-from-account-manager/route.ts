...
export async function GET(request: NextRequest) {
  try {
    ...
    // Get tasks with status "sent_for_review" that belong to admin's team
    // These are tasks that account manager sent back for review
    ...
    console.error('[GET_REVIEW_FROM_AM_TASKS]', error);
